...
export default function AddedAuthors() {
  const [selectedAuthor, setSelectedAuthor] = useState('2'); 
  ...
  const authors = [
    {
      ...
      position: '1st',
      name: 'Panchanan Deka',
      affiliation: 'ytjyjt, gfyjty, Guwah, IND',
    ...
    },
    {
      ...
      position: '2nd', 
      name: 'nasim deka',
      affiliation: 'eefreytru, eeeee, Guwah, USA',
      email: 'nasim@gmail.com',
      isCorresponding: true
    }
  ];

  const handleRadioChange = (authorId) => {
  ...
  return (
    <div className="bg-white mt-10 rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        {authors.map((author) => (
          <div key={author.id} className="px-6 py-5 hover:bg-gray-50 transition-colors">
              ...
              <div className="mr-6">
                <label className="flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={() => handleRadioChange(author.id)}
