...
export default function DecisonReviewer({ isOpen, onClose }) {
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start cursor-pointer group hover:bg-gray-50 p-3 rounded-lg transition-colors duration-200">
                      <input
                        type="radio"
                        name="question1"
                        value="falls-within-scope"
                        checked={question1 === "falls-within-scope"}
                    ...
                    <label className="flex items-start cursor-pointer group hover:bg-gray-50 p-3 rounded-lg transition-colors duration-200">
                      <input
                        type="radio"
                        name="question1"
                        value="does-not-fall-within-scope"
                        checked={question1 === "does-not-fall-within-scope"}
                        onChange={(e) => setQuestion1(e.target.value)}
                        className="w-5 h-5 text-black border-2 border-gray-300 mt-0.5"
                      />
                      <span className="ml-4 text-gray-700 group-hover:text-black transition-colors duration-200">
                        This paper does not fall within the scope of the journal
                      </span>
                    </label>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start cursor-pointer group hover:bg-gray-50 p-3 rounded-lg transition-colors duration-200">
                      <input
                        ...
                        checked={question2 === "no-review-needed"}
                    ...
                    <label className="flex items-start cursor-pointer group hover:bg-gray-50 p-3 rounded-lg transition-colors duration-200">
                      <input
                        ...
                        name="question2"
                        value="review-needed"
                        checked={question2 === "review-needed"}
                        onChange={(e) => setQuestion2(e.target.value)}
                        className="w-5 h-5 text-black border-2 border-gray-300 mt-0.5"
                      />
                      <span className="ml-4 text-gray-700 group-hover:text-black transition-colors duration-200">
