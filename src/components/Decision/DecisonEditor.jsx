...
export default function DecisonEditor({ isOpen, onClose }) {
  ...
  const reviewers = [
    ...
    },
    {
      ...
      decision: "Accept",
      commentsForEditor: "The title needs to be revised. Author needs to define young population. The population range is from 15 to 50 years, which does not coincides with title. Aims of the study shall be new or author shall clearly state what is the purpose of this study and new findings now. Shall be revised.",
      commentsForAuthor: "",
      files: ""
    }
  ];
    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Journal Review System</h2>
            <p className="text-sm text-gray-500 mt-1">Review and provide feedback on the submitted manuscript</p>
          </div>
          <button
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Question 1</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Question 2</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Decision</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Comments For Editor</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Comments For Author</th>
                    ...
                    <tr key={index} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 text-sm text-gray-600 max-w-xs">
                        {reviewer.commentsForEditor && (
                          <div className="truncate" title={reviewer.commentsForEditor}>
                            {reviewer.commentsForEditor}
                          </div>
                        )}
                      </td>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center mb-3">
                  ...
                  <label className="text-lg font-medium text-gray-900">Comments</label>
                </div>
                <textarea
                  value={comments}
            ...
            <div>
              <div className="flex items-center mb-3">
                ...
                <label className="text-lg font-medium text-gray-900">Decision</label>
              </div>
              <div className="space-y-3">
                {["Accept", "Reject", "Minor Revision", "Major Revision"].map((option) => (
