...
const PreviewArticlePage = () => {
  ...
  const journalData = {
    ...
    title:
      "Advanced Machine Learning Approaches for Predictive Healthcare Analytics: A Comprehensive Study on Early Disease Detection",
    authors: [
      {
      ...
      },
      {
        ...
        affiliation: "Stanford AI Laboratory, Stanford University",
        email: "m.chen@stanford.edu",
        orcid: "0000-0003-2156-8904",
      },
      {
      ...
      },
      {
        ...
        email: "j.wilson@deepmind.com",
        orcid: "0000-0004-3321-1098",
      },
    ],
    journal: {
      name: "Nature",
    ...
    publication: {
      ...
      pageCount: 13,
      articleNumber: "7123",
      publishedOnline: "2024-03-15",
      publishedPrint: "2024-03-21",
      received: "2024-01-10",
      accepted: "2024-02-28",
    ...
    funding: [
      "National Science Foundation Grant #NSF-2024-ML-001",
      "National Institutes of Health Grant #NIH-R01-AI-2024-456",
      "Google Research Grant #GRG-2024-Healthcare-789",
    ],
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <ArticleContent>
          ...
          <div dangerouslySetInnerHTML={{__html: inntroHtml}}>
